<!-- Exported from the shareable Claude doc "Ride The Wave Handbook" (last export 2026-09-24). Edit the doc and re-export, or edit here and mirror the change; keep the two in step. -->
...
**Correction, 24 September.** The engine's "hold the universe" benchmark averaged every stock ever selected during a run, including stocks that joined later because they had risen: a hindsight benchmark. Fixed to point-in-time. On a survivorship-free monthly top 100 from 2017 (active and delisted stocks), the universe earned 16.8% a year, not 22.4%, and long-only price momentum (23.9% a year) beats it by 5.0 and 8.9 points in the two halves: information ratio 0.51, t 1.6, the leading daily candidate but short of the t ≥ 2 gate. Residual momentum in high-volatility chop earns +41% a year over the universe on those days (t 2.4, 231 days). Every long-short version still loses. The shadow momentum portfolio now uses the bot's live most-active universe instead of the hindsight list of 20 mega caps.
...
**Status.** Three observation slots run in shadow from 24 September, deciding at 15:40 ET with legs filled against live OPRA quotes at a quarter of the half-spread: an iron condor on SPY gated on the volatility risk premium, a bull put spread on QQQ, a covered call on AAPL. Live placement as one multi-leg order on the paper account exists but stays off until fills are reconciled. Backtested 24 September on chains rebuilt from Alpaca's daily option bars (February 2024 to September 2026, SPY, QQQ and IWM monthly expiries, expired contracts included), replaying the bot's own slot code with fills crossing the full modelled spread: 144 configurations. Iron condors lose in a rising market. The bull put spread with strikes 5% and 10% out, entered only when implied volatility exceeds realised by 3 points and held to the day before expiry, matched or beat each index's Sharpe (QQQ 1.56 against 1.08, SPY 1.13 against 1.16) with about a third of its drawdown, positive in both halves on all three; it sat out the April 2025 crash because the gate was closed. About 20 trades per underlying, so a candidate to observe, not a proven edge. The shadow slots now run exactly these settings on SPY and QQQ, plus a gated covered call on QQQ. Feature 22; verified API facts in docs/api/options.md.
...
| 24 Sep | News as a daily feature: Jev event extraction on 2019 to 2026 headlines; four pre-registered tests | 357,240 headline-symbol pairs, survivorship-free top 100, $23 | News volume adds 0.2% to volatility forecasts (needed 10%); sentiment quintile spread t under 1.2; excluding negative news cuts momentum's IR from 0.53 to 0.19; the newsworthy half does not beat the universe. Negative news recovers +25 bp over 20 days (t 0.9) | All four fail; no news feature adopted; scores kept as an event database |
| 24 Sep | Daily engine benchmark made point-in-time; strategies re-run | 2017 to 2026, 7,786 active and delisted stocks, monthly top 100 | Universe 16.8%/yr (was 22.4%). Long-only price momentum IR 0.51 (t 1.6), both halves positive; residual momentum in high-vol chop t 2.4; long-short loses | Long-only momentum is the leading daily candidate; shadow slot moved to the live universe |
| 24 Sep | Options backtest on rebuilt chains: 6 structures, 3 underlyings, strike distance, volatility gate, exits | Feb 2024 to Sep 2026, SPY/QQQ/IWM monthlies, 144 configurations, full spread paid | Iron condors lose. Gated 5%-out bull put spread held to expiry: QQQ Sharpe 1.56 (index 1.08), SPY 1.13 (1.16), IWM 0.58 (0.79), drawdowns about a third of the index's, both halves positive; about 20 trades each | First family that holds up on risk; shadow slots switched to these settings; not live |
