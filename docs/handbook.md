<!-- Exported from the shareable Claude doc "Ride The Wave Handbook" (last export 2026-09-23). Edit the doc and re-export, or edit here and mirror the change; keep the two in step. -->
